...
The programs that gets placed in the `oeis_divergent` dir often have comments at the bottom, with verbose info about how they were mined.
...
paths = absolute_paths_for_all_programs(OEIS_DIVERGENT_DIR)
